...
initial_prompt = (
 ...
 "학생이 LaTeX 형식으로 입력한 수학 수식(예: x^2 + y^2 = z^2)은 컴파일하여 수식 형태로 보여주세요. 챗봇이 제시한 내용도 같이 LaTeX 문법을 자동 인식해 적절하게 수식으로 출력해야 합니다. 단, LaTeX 문법 오류가 있는 경우에는 오류 메시지를 출력하지 말고, 자연스럽게 올바른 수식 입력 예시를 제시하며 유도하세요."
