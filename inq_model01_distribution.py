...
def page_1():
    ...
    user_number = st.text_input("학번", value=st.session_state.get("user_number", ""), key="user_number")
    user_name = st.text_input("이름", value=st.session_state.get("user_name", ""), key="user_name")
